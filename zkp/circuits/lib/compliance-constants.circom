...
// substitute one for the other. They were previously written as bare 1 and 2 at
// six sites; naming them once keeps the compliance tree's leaf encoding, which
// the off-chain publisher must match exactly, in a single place.
//
